...
class Pair(object):
    ...
    def __init__(self, material1,material2,surface1,surface2,multiplicity1,multiplicity2,strains):
	"""
	Attributes:
...
# Set the  values for material B
	...
	for index_b in indices_b:
		...
		if epitaxy:
		        ...
		        surface_super_cell_a = np.asarray(surface_vector_1[0:2])*np.asarray(a)
		        print "Surface super-cell vector: ",surface_super_cell_a  
		        surface_super_cell_b = np.asarray(surface_vector_2[0:2])*np.asarray(b)
